...
public class Library {
    ...
    public Object[][] getBooksAsArray() {
        Object[][] array = new Object[availableBooks.size()][4];
        for (int i = 0; i < availableBooks.size(); i++) {
            Book book = availableBooks.get(i);
            array[i][0] = book.getTitle();
            array[i][1] = book.getAuthors();
            array[i][2] = book.getIsbn();
            array[i][3] = book.isBorrowed();
        }
        return array;
    }
    ...
    public void addBook(Book book, DefaultTableModel tableModel) {
        availableBooks.add(book);
        // Add the book to the table model
        Object[] rowData = {book.getTitle(), book.getAuthors(), book.getIsbn(), book.isBorrowed()};
